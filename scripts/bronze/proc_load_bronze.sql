...
BEGIN
		...
		BEGIN TRY
			...
			PRINT '>> Inserting Data into table Table: bronze.crm_cust_info';
			BULK INSERT DataWarehouse.bronze.crm_cust_info
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\cust_info.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
			...
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\prd_info.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
			...
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\sales_details.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
			...
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\cust_az12.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
			...
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\loc_a101.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
			...
			FROM 'C:\Users\Saumya Kumari\Desktop\STUDY\Data_Warehouse\px_cat_g1v2.csv'
			WITH (
				FIRSTROW = 2,
				FIELDTERMINATOR = ',',
				TABLOCK
